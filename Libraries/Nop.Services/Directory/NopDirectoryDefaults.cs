namespace Nop.Services.Directory
{
    ...
    public static partial class NopDirectoryDefaults
    {
        ...
        public static string DistrictAllCacheKey => "Nop.district.all-{0}-{1}";
        public static string WardAllCacheKey => "Nop.ward.all-{0}-{1}";
        ...
        public static string DistrictsPrefixCacheKey => "Nop.district.";
        public static string WardsPrefixCacheKey => "Nop.ward.";
