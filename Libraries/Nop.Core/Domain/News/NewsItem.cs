...
namespace Nop.Core.Domain.News
{
    ...
    public partial class NewsItem : BaseEntity, ISlugSupported, IStoreMappingSupported
    {
        ...
        private ICollection<NewsCategoryMapping> _newsCategoryMappings;
        ...
        public virtual ICollection<NewsCategoryMapping> NewsCategoryMappings
        {
            get => _newsCategoryMappings ?? (_newsCategoryMappings = new List<NewsCategoryMapping>());
            protected set => _newsCategoryMappings = value;
        }
        /// <summary>
