...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial interface ICountryModelFactory
    {
        ...
        DistrictListModel PrepareDistrictListModel(DistrictSearchModel searchModel, StateProvince stateProvince);
        DistrictModel PrepareDistrictModel(DistrictModel model,
            StateProvince state, District district);
        WardListModel PrepareWardListModel(WardSearchModel searchModel, District district);
        WardModel PrepareWardModel(WardModel model,
